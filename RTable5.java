...
class RTable5 extends JFrame {
    ...
    int storedValue4 = -1;
    int storedValue5 = -1;
    int storedValue6 = -1;// Initialize with an invalid value
    String newcoins1;
    JLabel label10;
...
add(gifpanel);
    ...
    RTable5(String uname,String coins) {
        rTabelCoins = coins;
...
add(resultlabel);
        ...
        betValue.setBounds(700, 170, 200, 25);
        add(betValue);
        ...
        logout.addActionListener(new ActionListener() {
         ...
         button37.setBounds(700, 370, 100, 40);
         button38.setBounds(750, 210, 100, 40);
         button39.setBounds(800, 370, 100, 40);
         button40.setBounds(850, 210, 100, 40);
         button41.setBounds(900, 370, 100, 40);
         button42.setBounds(950, 210, 100, 40);
         button43.setBounds(1000, 370, 100, 40);
         button44.setBounds(1050, 210, 100, 40);
         button45.setBounds(1100, 370, 100, 40);
         button46.setBounds(1150, 210, 100, 40);
         button47.setBounds(1200, 370, 100, 40);
         button48.setBounds(1250, 210, 100, 40);
         ...
         button38.setBackground(Color.darkGray);
         button39.setBackground(Color.darkGray);
         button40.setBackground(Color.ORANGE);
         button41.setBackground(Color.ORANGE);
         button42.setBackground(Color.darkGray);
         button43.setBackground(Color.darkGray);
         button44.setBackground(Color.ORANGE);
         button45.setBackground(Color.ORANGE);
         button46.setBackground(Color.darkGray);
         button47.setBackground(Color.darkGray);
        ...
        button37.addActionListener(new MyActionListener6(1, 2, 3,4,5,6));
        button38.addActionListener(new MyActionListener6(4, 5, 6,7,8,9));
        button39.addActionListener(new MyActionListener6(7, 8, 9,10,11,12));
        button40.addActionListener(new MyActionListener6(10,11,12,13,14,15));
        button41.addActionListener(new MyActionListener6(13,14,15,16,17,18));
        button42.addActionListener(new MyActionListener6(16,17,18,19,20,21));
        button43.addActionListener(new MyActionListener6(19,20,21,22,23,24));
        button44.addActionListener(new MyActionListener6(22,23,24,25,26,27));
        button45.addActionListener(new MyActionListener6(25,26,27,28,29,30));
        button46.addActionListener(new MyActionListener6(28,29,30,31,32,33));
        button47.addActionListener(new MyActionListener6(31,32,33,34,35,36));
...
if (abc == storedValue1 || abc == storedValue2 || abc == storedValue3 || abc == storedValue4 ||abc == storedValue5||abc == storedValue6)
                     {
...
class MyActionListener6 implements ActionListener {
    ...
    public MyActionListener6(int parameter1, int parameter2, int parameter3, int parameter4,int parameter5,int parameter6) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        RTable5 rTable5 = (RTable5) button.getTopLevelAncestor();



        System.out.println("rTable5.storedValue1 be" + rTable5.storedValue1);  


        rTable5.storedValue1 = this.myParameter1;
        rTable5.storedValue2 = this.myParameter2;
        rTable5.storedValue3 = this.myParameter3;
        rTable5.storedValue4 = this.myParameter4;
        rTable5.storedValue5 = this.myParameter5;
        rTable5.storedValue6 = this.myParameter6;
        
  
        
        System.out.println("rTable5.storedValue1 af" + rTable5.storedValue1); 
    }
}
